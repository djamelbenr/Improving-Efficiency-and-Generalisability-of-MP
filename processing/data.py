...
##--The NGSIM and HighD datasets stand as publicly accessible resources. 
##To facilitate ease of use, an initial preprocessing step is undertaken, 
##utilizing dedicated code to convert them into MAT files structured according to the following format:

'''
% Data: Each row in this dataset represents a unique observation, and the columns are structured as follows (#row = data number, #column = 138 (13+grid_num)):
%{
0: Dataset Id
1: Vehicle Id
|2 : Frame Id - Identifies the frame within the dataset
|3 : Local X - Local x-coordinate of the vehicle's position
|4 : Local Y - Local y-coordinate of the vehicle's position
|5 : Lane Id - Identifier for the lane in which the vehicle is located
|6 : Lateral maneuver - Describes the lateral movement strategy
|7 : Longitudinal maneuver - Defines the longitudinal movement strategy
|8 : Length - Length of the vehicle
|9 : Width - Width of the vehicle
|10: Class label - Categorization of the vehicle based on type or behavior
|11: Velocity - Instantaneous velocity of the vehicle
|12: Acceleration - Acceleration of the vehicle
|13-137: Neighbor Car Ids at respective grid locations - Identifiers of neighboring vehicles at specific grid locations
%}
'''

'''
% Tracks: Each cell in this structure is identified by {Dataset_Id * Vehicle_Id}, and within each cell, #row = 136 (11+grid_num), #column = totalFrameNum:
%{
|0 : Frame Id - Identifies the frame within the track cell
|1 : Local X - Local x-coordinate of the vehicle's position
|2 : Local Y - Local y-coordinate of the vehicle's position
|3 : Lane Id - Identifier for the lane in which the vehicle is located
|4 : Lateral maneuver - Describes the lateral movement strategy
|5 : Longitudinal maneuver - Defines the longitudinal movement strategy
|6 : Length - Length of the vehicle
|7 : Width - Width of the vehicle
|8 : Class label - Categorization of the vehicle based on type or behavior
|9 : Velocity - Instantaneous velocity of the vehicle
|10: Acceleration - Acceleration of the vehicle
|11-135: Neighbor Car Ids at corresponding grid locations - Identifiers of neighboring vehicles at specific grid locations within the track cell
%}
'''
